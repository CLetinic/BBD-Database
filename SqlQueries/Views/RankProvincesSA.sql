CREATE VIEW RankProvincesSA
AS
SELECT RANK() OVER (ORDER BY AVG(LM.AvgMark) DESC) [Position] ,E1.[Name] [Province], AVG(LM.AvgMark) [Average Mark]--, * --LM.SchoolId, LM.AvgMark--E.[Name] [SchoolName], LM.AvgMark
